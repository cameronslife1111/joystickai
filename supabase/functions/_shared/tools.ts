...
export const TOOL_CATALOG: ToolDef[] = [
  ...
  },
  {
    ...
    description:
      ...
      "Available Resolve tools — use these names EXACTLY and nothing else: get_project_info, get_resolve_version, list_projects, open_project, create_project, save_project, close_project, open_page, get_current_page, get_project_setting, set_project_setting, list_project_settings, list_timelines, get_timeline_info, create_timeline, set_current_timeline, rename_timeline, duplicate_timeline, delete_timeline, set_timeline_resolution, set_timeline_aspect, set_timeline_frame_rate, get_timeline_start_timecode, set_timeline_start_timecode, get_timeline_item_count, set_timeline_setting, import_timeline_file, export_timeline, get_track_count, list_tracks, rename_track, add_track, delete_track, enable_track, disable_track, enable_all_tracks, disable_all_tracks, lock_track, unlock_track, lock_all_tracks, unlock_all_tracks, mute_audio_track, unmute_audio_track, solo_audio_track, list_timeline_clips, get_clip_info, set_clip_property, set_clip_color, set_clip_flag, clear_clip_flags, set_clip_speed, set_clip_zoom, set_clip_position, set_clip_crop, set_clip_opacity, set_clip_rotation, set_clip_volume, set_clip_pan, delete_clip, set_playhead_timecode, get_playhead_timecode, append_clip_to_timeline, copy_clip_to_track, list_media_pool_clips, list_media_pool_folders, create_media_pool_folder, set_current_folder, move_clips_to_folder, delete_media_pool_clips, import_media, import_media_folder, get_clip_property, set_media_clip_property, find_clip, create_timeline_from_clips, relink_clips, unlink_clips, apply_lut, set_cdl, grade_clip, list_color_versions, add_color_version, load_color_version, delete_color_version, copy_grade, grab_still, apply_drx_grade, add_fusion_effect, set_fusion_input, list_fusion_nodes, delete_fusion_node, add_fusion_comp, delete_fusion_comp, add_marker, list_markers, delete_marker, set_clip_metadata, list_render_options, render_timeline, get_render_status, stop_render. " +
      "Shape hints: set_timeline_aspect takes {\"aspect\":\"vertical\"|\"square\"|\"widescreen\"|\"uhd\"|\"cinema\"|\"4:5\"}; track tools take {\"kind\":\"video\"|\"audio\"|\"subtitle\",\"track\":1}; timeline clip tools take {\"track\":1,\"index\":1}; copy_clip_to_track takes {\"clip\":\"name as shown on the timeline\",\"to_track\":6,\"kind\":\"video\",\"from_track\":2 (optional),\"all_matches\":true} and duplicates onto that track at the identical start frame without touching the original. " +
