...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Focus Remote: a simple remote control for reading, thinking, and directing AI-assisted work one step at a time." },
      { name: "theme-color", content: "#1a0f2e" },
      { property: "og:title", content: "Focus Remote — Control the flow of your focus" },
      { property: "og:description", content: "Focus Remote: a simple remote control for reading, thinking, and directing AI-assisted work one step at a time." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Focus Remote — Control the flow of your focus" },
      { name: "twitter:description", content: "Focus Remote: a simple remote control for reading, thinking, and directing AI-assisted work one step at a time." },
