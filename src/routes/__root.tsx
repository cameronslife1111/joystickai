...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "🟣 Orby — Focus on one thing at a time" },
      { name: "description", content: "Orby: a focus tool that shows you one sentence at a time. Move through your checklists & documents with a single glowing orb." },
      { name: "theme-color", content: "#1a0f2e" },
      { property: "og:title", content: "🟣 Orby — Focus on one thing at a time" },
      { property: "og:description", content: "Orby: a focus tool that shows you one sentence at a time. Move through your checklists & documents with a single glowing orb." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "🟣 Orby — Focus on one thing at a time" },
      { name: "twitter:description", content: "Orby: a focus tool that shows you one sentence at a time. Move through your checklists & documents with a single glowing orb." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Inter:wght@400;500;600;700&family=Syne:wght@600;700;800&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" },
    ],
  }),
